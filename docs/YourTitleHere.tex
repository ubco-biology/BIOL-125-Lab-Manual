...
\emph{Last updated 2021-11-25}

Welcome to the Biology 125 Labs for Biology for Science Majors II!
...
\hypertarget{lab-format}{%
\section*{Lab format}\label{lab-format}}
\addcontentsline{toc}{section}{Lab format}

Labs will be run in both an asynchronous - online - and synchronous - on campus - format. Be mindful of the schedule.

Failure to attend an on-campus lab due to students not reading their syllabus and schedule thoroughly will result in a mark of zero for that lab and an absence score of 2.5.

You cannot exceed an absence score of 5 as this results in failing the lab. See your syllabus for details.
...
To help you in this endeavour, you may wish to review the content from BIOL116 on experimental design -- \href{https://ubco-biology.github.io/BIOL-116-Lab-Manual/design-experiment-plan-analysis.html}{Designing the Experiment}.
...
This week's lab content can be found \href{https://ubco-biology.github.io/OS-Introduction/}{here}. You are asked to cover Part 2.
...
Failure to submit properly or submitting an incorrect document will be penalized. Assignments submitted within 24 hours of the due date will receive a 10\% penalty and no submissions will be accepted after that.
...
In order to help you better understand how to write a results section you are asked to edit the results section of the following docuemt:
...
Regardless of the fact that you are working in partners for your experimental project this assignment is an individual assignment and must be submitted on Canvas.
...
\midrule
\endhead
Results & Includes graphs / figures. No raw data is provided outside of supplemental (not required). Clearly outlines the findings from the study. Flow is sensible with figures present immediately following paragraphs describing the results of figure. \\
...
Results & Includes graphs / figures. No raw data is provided outside of supplemental (not required). Clearly outlines the findings from the study. Flow is sensible with figures present immediately following paragraphs describing the results of figure. & 4 \\

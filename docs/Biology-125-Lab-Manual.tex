...
\addcontentsline{toc}{chapter}{Assignment: Lab 4}
...
File Uploads \& Format & A minimum of 4 files have been submitted (pdf, Rmd, dataset(s), data dictionary). Report has been submitted as \texttt{pdf} and RMarkdown. Report is no more than 5 pages (excluding references). Data has been submitted in Tidy format as \texttt{csv}. Data dictionary has been submitted as \texttt{.md}. & 5 \\
...
Click \href{https://osf.io/download/vzu5f}{here} to download a copy of the Earthworm Dissection Guide.

\includegraphics{images/Lab6_Earthworm_Dissection_Video.png}
...
\begin{figure}
\centering
\includegraphics{images/Lab6_giant_clam.png}
\caption{Giant Clam}
\end{figure}

\textbf{Clam Life Cycle}

\includegraphics{images/Lab6_clam_life_cycle.png}
\textbf{Clam Dissection Guide \& Video}

Click \href{https://osf.io/download/hy37u}{here} to download a copy of the Clam Dissection Guide.

\includegraphics{images/Lab6_Clam_Dissection_Video.png}
...
\begin{figure}
\centering
\includegraphics{images/Lab6_grass_hopper_life_cycle.png}
\caption{Grasshopper Life Cycle}
\end{figure}

\textbf{Grasshopper Dissection Guide \& Videos}

Click \href{https://osf.io/download/9uvxh}{here} to download a copy of the Grasshopper Dissection Guide.
...
\begin{figure}
\centering
\includegraphics{images/Lab8_perch_life_cycle.png}
\caption{Perch Life Cycle}
\end{figure}

\textbf{Perch Dissection Guide \& Video}

Click \href{https://osf.io/download/6qspd}{here} to download a copy of the Perch Dissection Guide.

\includegraphics{images/Lab8_Perch_Dissection_Video1.png}

\includegraphics{images/Lab8_Perch_Dissection_Video2.png}
...
\begin{figure}
\centering
\includegraphics{images/Lab8_rat_life_cycle.png}
\caption{Rat Life Cycle}
\end{figure}

\textbf{Rat Dissection Guide \& Video}

Click \href{https://osf.io/download/d4kgz}{here} to download a copy of the Rat Dissection Guide.

\includegraphics{images/Lab8_Rat_Dissection_Video.png}
...
\addcontentsline{toc}{chapter}{Assignment: Lab 9}
...
\addcontentsline{toc}{part}{Lab 11}
...
This criterion is linked to a Learning Outcome \textbf{System Integration}. All systems and regulatory strategies have been thoroughly explained

\textbf{Possible Points 8}
...
This criterion is linked to a Learning Outcome \textbf{System Integration}. All systems and regulatory strategies have been thoroughly explained. This criterion is linked to a Learning Outcome System integration Systems are compatible with each other as described in the final version of the animal.

\textbf{Possible Points 10}
...
This criterion is linked to a Learning Outcome \textbf{Life Cycle}. The full life cycle has been provided and all structures and ploidy are indicated.

\textbf{Possible Points 4}
...
This criterion is linked to a Learning Outcome \textbf{Environment}. Explained how animal and their systems are compatible with the environment.

\textbf{Possible Points 2}
...
This criterion is linked to a Learning Outcome \textbf{Environment}. Description of how animal functions/lives/is affected by its environment.
...
\addcontentsline{toc}{subsection}{Overall}

This criterion is linked to a Learning Outcome \textbf{Overall description}. Backbone, body design, appendages, covering, size, etc. selections.

\textbf{Possible Points 3}
...
This criterion is linked to a Learning Outcome \textbf{Overall}. The presentation style is clear, had sensible flow, volume was appropriate, and the presenter was engaging
...
\hypertarget{scientific-information}{%
\subsection*{Scientific Information}\label{scientific-information}}
\addcontentsline{toc}{subsection}{Scientific Information}

This criterion is linked to a Learning Outcome \textbf{Scientific Information}. Details of the process of each system were conveyed with appropriate terminology.
...
This criterion is linked to a Learning Outcome \textbf{Presentation}. Evidence that the student can communicate their ideas accurately and in a meaningful way.
